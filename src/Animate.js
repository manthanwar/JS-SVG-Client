...
export default class Animate extends SvgParent {
 constructor(data) {
  super(data);
  this.setData(data);
  this.obj = this.newAnimate();
 }
 ...
 newAnimate() {
  const obj = document.createElementNS(this.data.ns, 'animate');
  this.setAttr(obj);
