// =============================================================================
// File Name     : FeOffset.js
// Description   : SVG FeOffset Class
// -----------------------------------------------------------------------------
...
export default class FeOffset extends SvgParent {
 constructor(data) {
  super(data);
  this.setData(data);
  this.obj = this.newFeOffset();
 }
 ...
 newFeOffset() {
  const obj = document.createElementNS(this.data.ns, 'feOffset');
  this.setAttr(obj);
